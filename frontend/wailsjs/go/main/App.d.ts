...
export function GenerateEmbeddingsForAll():Promise<void>;
...
export function SearchModels(arg1:string,arg2:number):Promise<Array<main.Model>>;

export function SearchStages(arg1:string,arg2:number):Promise<Array<main.Stage>>;
